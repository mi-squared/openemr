	...
	$(document).ready(function(){
		...
		function runCheckInCheck() {
			...
			if (pid) {
				...
				$.ajax({
					url:"<?= $_SERVER['CONTEXT_DOCUMENT_ROOT'] ?> /_ibh/ajax/get_patient_checkins.php",
					data:{pid:pid},
		...
		function runPAExceptions() {
			...
			$.ajax({
					url:"<?= $_SERVER['CONTEXT_DOCUMENT_ROOT'] ?>/_ibh/ajax/get_patient_pa_exceptions.php",
					data:{pid:pid},
					success: function(data) {
		...
		function runPriorAuthCheck() {
			...
			if (pid) {
				...
				$.ajax({
					url:"<?= $_SERVER['CONTEXT_DOCUMENT_ROOT'] ?>/_ibh/ajax/get_patient_prior_auths.php",
