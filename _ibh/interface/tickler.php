...
<script type="text/javascript">
	...
	$(".date_selector").on("click", ".form-list-item", function() {
		...
		$active_td.addClass("active").html("<div class='mini-form-name'>" + tit + "<a href='<?= $GLOBALS['webroot'] ?>/interface/patient_file/encounter/forms.php?set_encounter=" + enc + "&pid=" + pid + "' target='_blank' class='form-link'>open</a></div><div class='comp-date'>" + dat + "</div><div class='f-sign unsigned'></div>").attr("data-form_id", fid);
