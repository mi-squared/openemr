...
if ( $encounterLocked === false ) {
    ...
    if (sqlNumRows($lres)) {
      ...
      $title = $lrow['title'];
      $StringEcho.= "<tr><td style='border-top: 1px solid #000000;padding:0px;'><a class='form-picker' target='_self' href='" . $rootdir .'/patient_file/encounter/load_form.php?formname=' 
