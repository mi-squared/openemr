	...
	foreach ( $appts as $appointment ) {
		...
		if ($display) {
			...
			<tr class="details-row section-<?=$section?>">
	        	...
	        	<td><a class="encounter-setter" data-date="<?=$date_formatted?>" data-enc="<?=$appointment['encounter']?>" href="/openemr/interface/patient_file/encounter/forms.php?&pid=<?=$appointment['pid']?>&set_encounter=<?=$appointment['encounter']?>" target="RTop"><?=$appointment['encounter']?></a></td>
